              ...
              <div className="p-6 overflow-y-auto space-y-6 text-sm text-gray-600 custom-scrollbar">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg text-blue-900">
                  <p className="font-medium">
                    Bienvenue sur notre espace d'aide !
                  </p>
                  <p className="text-xs mt-1 text-blue-700">
                    Trouvez ici toutes les réponses pour naviguer facilement sur
                    notre plateforme de gestion de vols.
                  </p>
                </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-semibold text-gray-800">
                        Comment rechercher un vol ?
                      </h4>
                      <p className="mt-0.5">
                        Rendez-vous sur la page d'accueil, saisissez votre ville
                        de départ, votre destination ainsi que votre date de
                        voyage. Cliquez sur <strong>Rechercher</strong> pour
                        obtenir la liste des vols disponibles.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-800">
                        Où trouver les informations détaillées d'un vol ?
                      </h4>
                      <p className="mt-0.5">
                        Dans la liste des résultats de recherche, cliquez
                        simplement sur le vol qui vous intéresse. Vous serez
                        redirigé vers la page des{" "}
                        <strong>Détails du vol</strong> où vous trouverez les
                        aéroports exacts, les horaires et les tarifs.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-semibold text-gray-800">
                        À quoi sert l'icône en forme de cœur ?
                      </h4>
                      <p className="mt-0.5">
                        Le cœur vous permet de sauvegarder un vol qui vous
                        intéresse pour le retrouver plus tard rapidement, sans
                        avoir à refaire votre recherche.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-800">
                        Puis-je ajouter des favoris si je n'ai pas de compte ou
                        si je ne suis pas connecté ?
                      </h4>
                      <p className="mt-0.5">
                        <strong>Oui !</strong> Vous pouvez cliquer sur le cœur
                        même sans être connecté. Le site vous inviterá
                        automatiquement à vous connecter ou à créer un compte.
                        Un message jaune s'affichera pour vous guider :{" "}
                        <em>"Connecte-toi pour ajouter ce vol aux favoris."</em>
                      </p>
                      <p className="mt-1 font-medium text-emerald-600">
                        ✨ Magie : Dès que votre connexion réussit, le vol est
                        sauvegardé automatiquement et vous revenez directement
                        sur votre page précédente !
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-800">
                        Comment savoir si un vol est bien enregistré dans mes
                        favoris ?
                      </h4>
                      <p className="mt-0.5">
                        Si le cœur est <strong>rouge</strong>, le vol est
                        sauvegardé. Une notification apparaît en bas de votre
                        écran : <em>"Vol ajouté à vos favoris ! ✨"</em>. Si le
                        cœur est <strong>vide</strong>, le vol n'est pas dans
                        vos favoris.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-800">
                        Comment retirer un vol de mes favoris ?
                      </h4>
                      <p className="mt-0.5">
                        Cliquez simplement une nouvelle fois sur le cœur rouge
                        (depuis la liste de recherche ou la page des détails).
                        Le cœur deviendra vide et un message confirmera le
                        retrait.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="mt-0.5">
                        Vérifiez que votre adresse email et votre mot de passe
                        sont correctement orthographiés. Vous pouvez cliquer sur
                        l'icône en forme d'œil (👁️) dans le champ du mot de
                        passe pour l'afficher en clair et vérifier votre saisie.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-800">
                        Mes favoris sont-ils enregistrés si je change d'appareil
                        ?
                      </h4>
                      <p className="mt-0.5">
                        Si vous êtes connecté à votre compte, vos favoris sont
                        synchronisés en toute sécurité sur nos serveurs. Vous
                        les retrouverez instantanément, que vous soyez sur votre
                        ordinateur ou votre téléphone portable.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg text-amber-900 text-xs">
                  ...
                  <p>
                    Notre support technique est à votre écoute ! Si vous
                    rencontrez un message <em>"Erreur serveur"</em>, fermez
                    votre navigateur et réessayez dans quelques instants.
                  </p>
                </div>
              </div>
